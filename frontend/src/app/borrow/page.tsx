...
const BorrowPage = () => {
    ...
    const [isWhitelistedLocally, setIsWhitelistedLocally] = useState(isWhitelisted);
    ...
    }, [isConnected, account, balanceLoading, balance, toast]);
    ...
    const handleWhitelistAddress = async () => {
        ...
        try {
            const response = await fetch(`${backendUrl}/whitelist`, {
                ...
                body: JSON.stringify({ account, isWhitelisted: true }),
            });
                    ...
                    {account && (
                        <>
                            ...
                            <Button
                                ...
                                onClick={
                                    isWhitelistedLocally || isWhitelisted
                                        ? handleBorrowTokens
